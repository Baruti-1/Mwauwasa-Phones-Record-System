<?php
	...
	// ON records.route = replacement.route_r order by route asc";
		...
		$query = "SELECT * FROM records WHERE phone_model LIKE '%infinix%' AND zone LIKE '%A%'";
...
<body>
	...
	<form action="method.php" method="POST" class="form-inline text-center">
		<select name="zone" id="zone" class="form-control ml-2 mr-2">
	...
	<div class="form-group">
		<select name="model" id="model" class="form-control mr-2">
	...
	<th>
		<button class="btn btn-secondary mr-2" name="filter" id="filter">FILTER</button>
	</th>
	</form>
	</div>
