...
if (isset($_POST['ADD'])) {
	...
	// Checking if two IMEI are different
	if($imei1 != $imei2){
		...
		// Checking if replaced phone is not existing
		if($rw1 == 0){
			...
			// If the replaced phone exist replace it add update its details
...
" class="" required>
	...
	<div class="break2">
		...
		<input type="number" min="1" name="number" placeholder="11" class="fit2" value="<?php echo strtoupper($rw['route']); ?>" required readonly>
		<br></br>
		<label><strong>ZONE:</strong></label>
		<input type="text" name="zone" placeholder="F" class="fit" required maxlength="1" value="<?php echo strtoupper($rw['zone']); ?>" readonly>
		<br></br>
